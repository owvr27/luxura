...
router.get('/api/images', authRequired, async (_req: Request, res: Response) => {
  try {
    await ensurePhotosDir();
...
router.get('/api/images/:filename', authRequired, async (req: Request, res: Response) => {
  try {
...
router.get('/api/images/latest', authRequired, async (_req: Request, res: Response) => {
  try {
    await ensurePhotosDir();
...
router.delete('/api/images/:filename', authRequired, adminOnly, async (req: Request, res: Response) => {
  try {
    const { filename } = req.params;
