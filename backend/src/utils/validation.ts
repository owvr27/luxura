import { z } from 'zod';
import type { RegisterRequest, LoginRequest, ChatRequest, WasteClassificationRequest } from '../types/index.js';
...
export const wasteSchemas = {
  ...
  }) satisfies z.ZodType<WasteClassificationRequest>,
};
...
export function validateParams<T>(schema: z.ZodType<T>, params: any): T {
